...
var index_2 = require("./components/playground/index");
var App_style_1 = require("./App.style");
var App = function () {
    var styles = App_style_1["default"]();
    ...
    return (react_1["default"].createElement("div", { className: styles.root }, isLoggedIn ? react_1["default"].createElement(index_2["default"], null) : react_1["default"].createElement(index_1["default"], { onSubmit: onSubmit })));
};
exports["default"] = App;
